...
<![endif]-->
    ...
    <div class="axil-typography-area axil-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="typography-inner">
                        ...
                        <p class="b1">B1 - Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta minima, provident quos amet non hic animi. Natus dolorum reprehenderit debitis voluptatem magnam beatae itaque dicta vitae! Magni esse ex rem.</p>
                        <p class="b2">B2 - Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta minima, provident quos amet non hic animi. Natus dolorum reprehenderit debitis voluptatem magnam beatae itaque dicta vitae! Magni esse ex rem.</p>
                        <p class="b3">B3 - Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta minima, provident quos amet non hic animi. Natus dolorum reprehenderit debitis voluptatem magnam beatae itaque dicta vitae! Magni esse ex rem.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="axil-product-list">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-cart">
                                ...
                                <a href="{{route('addlike.to.wishlist' , $sub -> id)}}" class="cart-btn"><i class="fal fa-heart"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="axil-product-list">
