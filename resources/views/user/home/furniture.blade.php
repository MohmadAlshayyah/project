                ...
                <div class="categrie-product-activation-2 categorie-product-two slick-layout-wrapper--15">
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-1.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-2.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-3.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-4.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-5.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-6.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-7.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-8.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-9.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-11.png" alt="product categorie">
                    ...
                    <div class="slick-single-layout slick-slide">
                        <div class="categrie-product-2">
                            <a href="#">
                                <img class="img-fluid" src="/asset/images/product/categories/furni-12.png" alt="product categorie">
                    ...
                    <div class="slider-activation-two axil-slick-dots">
                        <div class="single-slide slick-slide">
                            <div class="main-slider-content">
                                ...
                                <div class="shop-btn">
                                    <a href="{{route('user.shop')}}" class="axil-btn btn-bg-white"><i class="fal fa-shopping-cart"></i> Shop Now</a>
                                </div>
                            </div>
                            <div class="main-slider-thumb">
                                <img src="/asset/images/product/product-47.png" alt="Product">
                            </div>
                        </div>
                        <div class="single-slide slick-slide">
                            <div class="main-slider-content">
                            ...
                            <div class="main-slider-thumb">
                                <img src="/asset/images/product/product-48.png" alt="Product">
                            </div>
                        </div>
                        <div class="single-slide slick-slide">
                            <div class="main-slider-content">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    ...
                                    <li class="select-option"><a href="{{route('user.variation5')}}">Add to Cart</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-19.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-22.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-23.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-25.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-20.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-21.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-18.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="axil-product product-style-seven">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy" src="/asset/images/product/furniture/product-24.png" alt="Product Images">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row row--10">
                                <div class="col-6">
                                    <div class="thumbnail thumbnail-1">
                                        <img src="/asset/images/about/about-04.png" alt="About">
                                    </div>
                                    <div class="thumbnail thumbnail-2">
                                        <img src="/asset/images/about/about-06.png" alt="About">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="thumbnail thumbnail-3">
                                        <img src="/asset/images/about/about-05.png" alt="About">
                                    </div>
                                    <div class="thumbnail thumbnail-4">
                                        <img src="/asset/images/about/about-07.png" alt="About">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="new-arrivals-product-activation-2 slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide product-slide-mobile">
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src="/asset/images/product/furniture/product-10.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="1500" src="/asset/images/product/furniture/product-11.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="1500" src="/asset/images/product/furniture/product-12.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="1500" src="/asset/images/product/furniture/product-13.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src="/asset/images/product/furniture/product-14.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="1500" src="/asset/images/product/furniture/product-15.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="1500" src="/asset/images/product/furniture/product-8.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="1500" src="/asset/images/product/furniture/product-9.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-three">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src="/asset/images/product/furniture/product-6.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="{{route('addlike.to.wishlist' , $sub -> id)}}"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="poster-countdown-thumbnail">
                                <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src="/asset/images/product/poster/poster-07.png" alt="Poster Product">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <h5 class="title"><a href="{{route('user.variation5')}}">{{ $sub -> name}}</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">{{$sub -> category}}</span>
                                                <span class="price old-price">{{ $sub -> old}}</span>
                                            </div>
                    ...
                    @foreach($hhs as $sub)
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="{{route('user.variation5')}}">
                                    <img  style="width: 240px; height: 220px;" src="{{asset('images/offers/'.$sub -> photo)}}">                                       </a>
                                    <div class="label-block label-right">
