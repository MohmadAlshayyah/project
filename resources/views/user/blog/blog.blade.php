                ...
                <div class="row row--25">
                    <div class="col-lg-8 axil-post-wrapper">
                        ...
                        <div class="content-blog sticky mt--60">
                            <div class="inner">
                                <div class="content">
                                    <h4 class="title"><a href="{{route('user.details')}}">Dubai’s Offers its Take Nike SB
                                            Dunk.</a></h4>
                                    ...
                                    <div class="read-more-btn">
                                        <a class="axil-btn btn-bg-primary" href="{{route('user.details')}}">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="{{route('user.details')}}">
                                        <img src="/asset/images/blog/blog-01.png" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <h4 class="title"><a href="{{route('user.details')}}">UCLA Athletics Reaches Multi-Year
                        ...
                        <div class="content-blog format-quote mt--60">
                            <div class="inner">
                                <div class="content">
                                    <blockquote>
                                        <h4 class="title"><a href="{{route('user.details')}}">“An oral history of the AIM away
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-video.html">
                                        <img src="/asset/images/blog/blog-02.png" alt="Blog Images">
                                    </a>
                                ...
                                <div class="blog-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="thumbnail">
                                        <a href="blog-gallery.html">
                                            <img src="/asset/images/blog/blog-03.png" alt="Blog Images">
                                        </a>
                                    </div>
                                    <!-- End Single Thumb  -->
                                    <!-- Start Single Thumb  -->
