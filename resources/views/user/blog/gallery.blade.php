                        ...
                        <div class="inner">
                            <div class="blog-gallery-activation axil-slick-arrow arrow-between-side">
                                <div class="post-thumbnail">
                                    <img src="/asset/images/blog/blog-single-2.jpg.png" alt="blog Images">
                                </div>
                                <div class="post-thumbnail">
                                    <img src="/asset/images/blog/blog-single-3.jpg.png" alt="blog Images">
                                </div>
                            </div>
                            <!-- End .thumbnail -->
                        </div>
                            ...
                            <div class="post-heading">
                                ...
                                <div class="axil-post-meta">
                                    <div class="post-author-avatar">
                                        <img src="/asset/images/blog/author-image-1.png" alt="Author Images">
                                    </div>
                            ...
                            <div class="post-details wp-block-columns alignwide has-2-columns">
                                <div class="wp-block-column">
                                    <figure class="wp-block-image is-resized">
                                        <img class="img-fluid" src="/asset/images/blog/blog-01.png" alt="blog image">
                                    </figure>

                                </div>
                                <div class="wp-block-column">
                                    <figure class="wp-block-image is-resized">
                                        <img class="img-fluid" src="/asset/images/blog/blog-02.png" alt="blog image">
                                    </figure>
                                </div>
                            </div>
                        ...
                        <div class="content-blog">
                            <div class="inner">
                                <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="thumbnail">
                                        <a href="{{route('user.details')}}">
                                            <img src="/asset/images/blog/blog-07.png" alt="Blog Images">
                                        </a>
                                    </div>
                                    <!-- End Single Thumb  -->
                                </div>
                                <div class="content">
                                    <h5 class="title"><a href="{{route('user.details')}}">With an Irreverent Twist, AMBUSH® Highlights Converse's Outdoor Heritage</a></h5>
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="/asset/images/blog/author-image-1.png" alt="Author Images">
                                        </div>
                        ...
                        <div class="content-blog">
                            <div class="inner">
                                <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="thumbnail">
                                        <a href="{{route('user.details')}}">
                                            <img src="/asset/images/blog/blog-08.png" alt="Blog Images">
                                        </a>
                                    </div>
                                    <!-- End Single Thumb  -->
                                </div>
                                <div class="content">
                                    <h5 class="title"><a href="{{route('user.details')}}">UCLA Athletics Reaches Multi-Year
                                            Agreement with NIKE, Inc. and Jordan Brand</a></h5>
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="/asset/images/blog/author-image-2.png" alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            <h6 class="author-title">
                        ...
                        <div class="content-blog">
                            <div class="inner">
                                <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="thumbnail">
                                        <a href="{{route('user.details')}}">
                                            <img src="/asset/images/blog/blog-09.png" alt="Blog Images">
                                        </a>
                                    </div>
                                    <!-- End Single Thumb  -->
                                </div>
                                <div class="content">
                                    <h5 class="title"><a href="{{route('user.details')}}">An oral history of the AIM away
                                            message by the people who were there</a></h5>
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="/asset/images/blog/author-image-3.png" alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            <h6 class="author-title">
